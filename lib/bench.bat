...
REM ~ java trumco sweep.wav -pltht 1200 -pltln 2000 -logfs -mrsmp 50 -stspc 10000 -fnspc 29000
REM ~ java trumco aphex.wav -minhz 500 -maxhz 5000 -mrsmp 1233 -gamma 0.7 -stspc 8000 -fnspc 13000
java trumco aphex.wav -logfs -mrsmp 1050 -minhz 48 -pltht 600 -pltln 700 -maxhz 15125
